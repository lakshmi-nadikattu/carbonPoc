...
import { AbstractDropdownView } from "./abstractdropdown";
import { I18n,DropdownService } from "carbon-components-angular";
	...
	providers: [
		{
			...
			useExisting: Child1Component,
			multi: true
		}
	]
})
export class Child1Component implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, ControlValueAccessor {
	static dropdownCount = 0;
	@Input() id = `dropdown-${Child1Component.dropdownCount++}`;
	/**
